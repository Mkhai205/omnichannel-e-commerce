...
const CATEGORY_NOUNS: Record<string, string[]> = {
    ...
    womenFashion: ["Váy", "Áo kiểu nữ", "Đầm công sở", "Áo thun nữ"],
    menShoes: ["Giày thể thao nam", "Giày lười nam", "Giày da nam", "Giày chạy bộ nam"],
    womenShoes: ["Giày thể thao nữ", "Giày cao gót", "Giày búp bê", "Giày sandal nữ"],
    beautyHealth: ["Serum dưỡng da", "Kem chống nắng", "Máy chăm sóc da", "Thực phẩm bổ sung"],
    carMoto: ["Mũ bảo hiểm", "Phụ kiện xe máy", "Camera hành trình", "Dụng cụ chăm sóc xe"],
    kitchen: ["Máy xay", "Nồi chiên", "Ấm siêu tốc", "Bộ dụng cụ bếp"],
    householdAppliances: ["Máy hút bụi", "Quạt điện", "Đèn bàn", "Máy lọc không khí"],
    jewelryAccessories: ["Nhẫn", "Dây chuyền", "Lắc tay", "Bông tai"],
    homeLiving: ["Đèn bàn", "Kệ sách", "Ghế thư giãn", "Đồ gia dụng"],
    pets: ["Thức ăn thú cưng", "Vòng cổ", "Đồ chơi thú cưng", "Nhà cho thú cưng"],
    sports: ["Bóng đá", "Vợt cầu lông", "Dụng cụ tập gym", "Giày thể thao"],
    toys: ["Lego", "Gấu bông", "Xe điều khiển", "Bộ đồ chơi sáng tạo"],
    books: ["Sách kỹ năng", "Sách thiếu nhi", "Tiểu thuyết", "Sách kinh doanh"],
    vouchers: ["Voucher mua sắm", "Mã giảm giá", "Phiếu quà tặng", "Voucher dịch vụ"],
};
