    ...
    <section className="rounded-b-lg border-x border-b border-slate-200 bg-white">
      <Table>
        <TableHeader>
          <TableRow className="border-slate-200 bg-slate-50/80">
            <TableHead className="px-5 py-4 text-xs font-semibold uppercase tracking-[0.13em] text-slate-400">Chi tiết sản phẩm</TableHead>
            <TableHead className="px-5 py-4 text-xs font-semibold uppercase tracking-[0.13em] text-slate-400">Giá niêm yết</TableHead>
            <TableHead className="px-5 py-4 text-xs font-semibold uppercase tracking-[0.13em] text-slate-400">Giá khuyến mãi</TableHead>
            <TableHead className="px-5 py-4 text-xs font-semibold uppercase tracking-[0.13em] text-slate-400">Trạng thái</TableHead>
            <TableHead className="px-5 py-4 text-xs font-semibold uppercase tracking-[0.13em] text-slate-400">Trạng thái đồng bộ</TableHead>
            <TableHead className="px-5 py-4 text-xs font-semibold uppercase tracking-[0.13em] text-slate-400">Thao tác</TableHead>
          </TableRow>
        </TableHeader>
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.id} className="border-slate-200">
              ...
              <TableCell className="px-5 py-4 align-middle text-sm font-semibold text-slate-700">{formatCurrency(row.listedPrice)}</TableCell>

              <TableCell className="px-5 py-4 align-middle text-sm font-semibold text-red-600">{formatCurrency(row.promotionalPrice)}</TableCell>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 px-5 py-4 text-xs text-slate-400">
        <p className="font-semibold uppercase tracking-wide">
          Hiển thị {start}-{end} trên tổng số {totalProductsCount.toLocaleString("en-US")} sản phẩm
        </p>
