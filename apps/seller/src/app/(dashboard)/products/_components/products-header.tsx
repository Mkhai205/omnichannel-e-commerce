...
type ProductsHeaderProps = {
    ...
    onActionClick: (actionId: ProductActionButton["id"]) => void;
};
...
export function ProductsHeader({ actions, onActionClick }: ProductsHeaderProps) {
    return (
        <section className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-start">
            <div>
                ...
                <p className="mt-2 max-w-3xl text-balance text-left text-lg leading-relaxed text-slate-600">
                    Quản lý danh mục đa kênh, theo dõi trạng thái hiển thị và tối ưu tồn kho theo
                    từng sản phẩm để đảm bảo vận hành ổn định.
                </p>
            </div>
