...
export function InventoryProductsTable({
    ...
    const end =
        totalProducts === 0
            ? 0
            : Math.min((currentPage - 1) * pageSize + rows.length, totalProducts);
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 px-6 py-5">
                ...
                <div className="flex items-center gap-3">
                        ...
                        {warehouseOptions.map((option) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        "rounded-md px-4 py-2 text-sm font-semibold text-slate-500 disabled:cursor-not-allowed disabled:opacity-60",
                    ...
                    <Button
                        type="button"
                        variant="outline"
                        className="h-10 rounded-lg border-slate-300 px-4 text-sm font-semibold text-slate-600"
                    >
                    ...
                    <select
                        ...
                        disabled={isLoading}
                        onChange={(event) =>
                            onStatusChange(event.target.value as InventoryStatusFilter)
                        }
                        className="h-10 rounded-lg border border-slate-300 bg-white px-3 text-sm font-semibold text-slate-700 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                ...
                <TableBody>
                    ...
                    {!isLoading
                        ? rows.map((row) => (
                              ...
                              >
                                  <TableCell className="px-5 py-4 align-middle text-sm font-semibold text-blue-500">
                                      {row.sku}
                                  </TableCell>
                                  ...
                                  <TableCell className="px-5 py-4 align-middle text-xl font-semibold text-slate-800">
                                      {row.currentStock}
                                  </TableCell>
                            ...
                            <button
                                ...
                                className={
                                    isActive
                                        ...
                                        : "px-1 text-sm font-semibold text-slate-500 disabled:cursor-not-allowed disabled:opacity-60"
                                }
                            >
                                {item}
                            </button>
