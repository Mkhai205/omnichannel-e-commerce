...
import type { SellerAnalyticsTopCustomer } from "@repo/shared-types";

type TopCustomersCardProps = {
    customers: SellerAnalyticsTopCustomer[];
};
        ...
        <Card className="border-slate-200 bg-white">
            <CardHeader className="grid grid-cols-[1fr_auto] items-center gap-3">
                ...
                <Button
                    type="button"
                    variant="ghost"
                    className="h-9 px-2 text-xs font-semibold uppercase tracking-widest text-blue-600 hover:bg-blue-50"
                >
                    Xem tất cả
                </Button>
            </CardHeader>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-right text-xs uppercase tracking-widest text-slate-500">
                                LTV
                            </TableHead>
                        </TableRow>
                    </TableHeader>
