...
function getStatusClassName(status: OrderStatus) {
    if (status === "PENDING_PAYMENT") {
        return "border-blue-200 bg-blue-100 text-blue-600";
    }
            ...
            <Table>
                <TableHeader>
                    <TableRow className="bg-slate-100">
                        ...
                        <TableHead className="text-center font-extrabold">Khách hàng</TableHead>
                        <TableHead className="text-center font-extrabold">Ngày đặt</TableHead>
                        <TableHead className="text-center font-extrabold">Tổng tiền</TableHead>
                        <TableHead className="text-center font-extrabold">Trạng thái</TableHead>
                        <TableHead className="text-center font-extrabold">Đối soát</TableHead>
                    </TableRow>
                </TableHeader>
