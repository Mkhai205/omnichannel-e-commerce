    ...
    <section className="grid gap-4 lg:grid-cols-[2fr_0.9fr]">
      <Card className="relative overflow-hidden border-slate-800 bg-slate-950 text-slate-100 shadow-none">
        ...
        <CardHeader className="relative z-10 min-h-60 justify-center gap-4 px-6 py-8 sm:px-8">
          <span className="inline-flex w-fit rounded-md bg-blue-500 px-4 py-1.5 text-xs font-semibold tracking-wide text-white">MẸO TỐI ƯU</span>
          ...
          <CardDescription className="max-w-3xl text-lg leading-relaxed text-slate-300">
            Cân nhắc lên lịch các chiến dịch Flash Sale tiếp vào khung giờ vàng để tối ưu hóa tỷ lệ chuyển đổi khách hàng.
          </CardDescription>
        </CardHeader>
      </Card>
        ...
        <CardHeader className="min-h-60 justify-between px-6 py-8">
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <CardTitle className="text-4xl leading-tight text-white">Dự đoán AI</CardTitle>
              <CardDescription className="text-xl leading-relaxed text-white/90">
                Dựa trên xu hướng mua sắm, việc tạo chương trình "Mua 1 tặng 1" cho danh mục Phụ kiện vào cuối tuần này có thể tăng doanh số lên tới 35%.
              </CardDescription>
            </div>
          </div>
