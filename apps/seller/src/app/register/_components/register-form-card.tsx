  ...
  return (
    <section className="w-full rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:p-8">
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-semibold tracking-tight text-slate-900 lg:text-4xl">Tạo tài khoản mới</h2>
        <p className="max-w-md text-sm leading-relaxed text-slate-600">Bắt đầu hành trình kinh doanh chuyên nghiệp ngay hôm nay.</p>
      </div>

      <div className="mt-6 flex flex-col gap-3.5">
        <div className="flex flex-col gap-2">
          <label htmlFor="full-name" className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">
            Họ và tên
          </label>
          <Input
            id="full-name"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="phone-number" className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">
            Số điện thoại
          </label>
          <Input
            id="phone-number"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="business-email" className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">
            Email doanh nghiệp
          </label>
          <Input
            id="business-email"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="store-name" className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">
            Tên của hàng
          </label>
          <Input
            id="store-name"
